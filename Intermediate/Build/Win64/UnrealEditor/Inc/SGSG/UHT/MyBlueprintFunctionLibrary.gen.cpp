...
#include "SGSG/MyBlueprintFunctionLibrary.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMyBlueprintFunctionLibrary() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UBlueprintFunctionLibrary();
	SGSG_API UClass* Z_Construct_UClass_UMyBlueprintFunctionLibrary();
	SGSG_API UClass* Z_Construct_UClass_UMyBlueprintFunctionLibrary_NoRegister();
	UPackage* Z_Construct_UPackage__Script_SGSG();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_UMyBlueprintFunctionLibrary_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_SGSG,
	};
	...
	template<> SGSG_API UClass* StaticClass<UMyBlueprintFunctionLibrary>()
	{
		return UMyBlueprintFunctionLibrary::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_SGSG_Source_SGSG_MyBlueprintFunctionLibrary_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SGSG_Source_SGSG_MyBlueprintFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMyBlueprintFunctionLibrary, UMyBlueprintFunctionLibrary::StaticClass, TEXT("UMyBlueprintFunctionLibrary"), &Z_Registration_Info_UClass_UMyBlueprintFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMyBlueprintFunctionLibrary), 4073172159U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SGSG_Source_SGSG_MyBlueprintFunctionLibrary_h_2400460900(TEXT("/Script/SGSG"),
		Z_CompiledInDeferFile_FID_SGSG_Source_SGSG_MyBlueprintFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SGSG_Source_SGSG_MyBlueprintFunctionLibrary_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
